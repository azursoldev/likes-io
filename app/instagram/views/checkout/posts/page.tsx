...
function PostsSelectionContent() {
  ...
  const handleContinue = (e: React.FormEvent) => {
    ...
    if (isValidInstagramUrl(postLink)) {
      ...
      router.push(`/instagram/views/checkout/final?username=${username}&qty=${qty}&price=${priceValue}&type=${encodeURIComponent(packageType)}&postLink=${encodeURIComponent(postLink)}`);
    } else {
      setLinkError("Please enter a valid Instagram post or reel URL");
    }
  };
  ...
  const handleDetailsClick = () => {
    router.push(`/instagram/views/checkout?username=${username}&qty=${qty}&price=${priceValue}&type=${encodeURIComponent(packageType)}`);
  };
