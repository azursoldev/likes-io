      ...
      <div className="container">
        <div className="qs-grid">
          <div className="qs-left">
            <h2 className="qs-title">Get Started Now</h2>
            <p className="qs-desc">
              And importantly, Likes.io’s real followers, likes, views, and comments are available at very
              reasonable prices that are never higher than those charged by other reputable providers.
            </p>
            <p className="qs-desc">
              Honest, trustworthy, responsible, and powerful TikTok and Instagram growth is what we’ve specialized in
              for more than a dozen years. We invite you to join our family of satisfied customers today!
            </p>
          </div>
