...
function PostsSelectionContent() {
  ...
  const username = searchParams.get("username") || "aliahmed";
  ...
  const handleContinue = (e: React.FormEvent) => {
    ...
    if (isValidTikTokUrl(postLink)) {
      ...
      router.push(`/tiktok/likes/checkout/final?username=${username}&qty=${qty}&price=${priceValue}&type=${packageType}&postLink=${encodeURIComponent(postLink)}`);
    } else {
      setLinkError("Please enter a valid TikTok video URL");
    }
  };
  ...
  const handleDetailsClick = () => {
    router.push(`/tiktok/likes/checkout?username=${username}&qty=${qty}&price=${priceValue}&type=${encodeURIComponent(packageType)}`);
  };
                ...
                <div className="order-summary-section">
                  <div className="order-summary-item">
                    <div className="order-summary-left">
                      ...
                      <span className="order-summary-text order-summary-url">{postLink || `@${username}`}</span>
                    </div>
